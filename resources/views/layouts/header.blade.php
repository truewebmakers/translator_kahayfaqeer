    ...
    <div class="page-wrapper compact-wrapper " id="pageWrapper">
        <header class="page-header row">
            <div class="logo-wrapper d-flex align-items-center col-auto"><a href="/">
                <img class="light-logo img-fluid" src="{{ asset('assets/images/logo/kahe-faqeer-white-1.png') }}"
                        alt="logo" />
                <img class="dark-logo img-fluid" src="{{ asset('assets/images/logo/kaha-faqeer-dark.png') }}" alt="logo" /></a>
                        ...
                        <li class="profile-nav custom-dropdown">
                            <div class="user-wrap">
                                ...
                                <div class="user-content">
                                    ...
                                    <p class="mb-0">{{ $role }} {{ Auth::user()->user_level }}<i
