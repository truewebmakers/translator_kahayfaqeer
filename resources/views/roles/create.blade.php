                                ...
                                <div class="col-xl-12 col-sm-6 mb-4">
                                    <div class="card-wrapper border rounded-3 h-100 checkbox-checked custom-checkbox">
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" name="permission[]" value="{{ $value->name }}" class="checkbox" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
                                    ...
                                    <div class="card-wrapper border rounded-3 h-100 checkbox-checked custom-checkbox">
                                        ...
                                        @foreach ($permission as $k => $value)
                                            <div class="form-check checkbox checkbox-primary mb-0">
                                                <input class="form-check-input primary" id="checkbox-primary-{{$k}}" name="permission[]"  value="{{ $value->name }}" type="checkbox" >
